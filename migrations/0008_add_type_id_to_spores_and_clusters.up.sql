...
ALTER TABLE spores
ADD COLUMN type_id VARCHAR REFERENCES addresses(id);

-- Create index on type_id column in spores table
CREATE INDEX idx_spores_type_id ON spores (type_id);
...
CREATE INDEX idx_clusters_type_id ON clusters (type_id);
