...
impl AddressOptBuilder {
    ...
    where
        T: ::core::convert::Into<Option<Address>>,
    {
        self.0 = v.into();
        self
    }
...
impl MintBuilder {
    ...
    pub fn content_hash<T>(mut self, v: T) -> Self
    where
        T: ::core::convert::Into<Byte32>,
    {
        self.content_hash = v.into();
        self
    }
}
...
impl TransferBuilder {
    pub const FIELD_COUNT: usize = 3;
    pub fn nft_id<T>(mut self, v: T) -> Self
    where
        T: ::core::convert::Into<Byte32>,
    {
        self.nft_id = v.into();
    ...
    where
        T: ::core::convert::Into<AddressOpt>,
    {
        self.from = v.into();
        self
    }
...
impl SporeActionUnion {
    pub(crate) fn display_inner(&self, f: &mut ::core::fmt::Formatter) -> ::core::fmt::Result {
        match self {
            SporeActionUnion::Mint(item) => write!(f, "{}", item),
            SporeActionUnion::Transfer(item) => write!(f, "{}", item),
            SporeActionUnion::Melt(item) => write!(f, "{}", item),
        }
    }
}
impl<'r> SporeActionUnionReader<'r> {
    pub(crate) fn display_inner(&self, f: &mut ::core::fmt::Formatter) -> ::core::fmt::Result {
        match self {
            SporeActionUnionReader::Mint(item) => write!(f, "{}", item),
            SporeActionUnionReader::Transfer(item) => write!(f, "{}", item),
            SporeActionUnionReader::Melt(item) => write!(f, "{}", item),
        }
    }
}
...
impl From<Mint> for SporeAction {
    fn from(value: Mint) -> Self {
        Self::new_builder().set(value).build()
    }
}
impl From<Transfer> for SporeAction {
    fn from(value: Transfer) -> Self {
        Self::new_builder().set(value).build()
    }
}
impl From<Melt> for SporeAction {
