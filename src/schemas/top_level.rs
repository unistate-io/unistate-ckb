...
impl WitnessLayoutUnion {
    pub(crate) fn display_inner(&self, f: &mut ::core::fmt::Formatter) -> ::core::fmt::Result {
        match self {
            WitnessLayoutUnion::SighashAll(item) => write!(f, "{}", item),
            WitnessLayoutUnion::SighashAllOnly(item) => write!(f, "{}", item),
            WitnessLayoutUnion::Otx(item) => write!(f, "{}", item),
            WitnessLayoutUnion::OtxStart(item) => write!(f, "{}", item),
        }
    }
}
impl<'r> WitnessLayoutUnionReader<'r> {
    pub(crate) fn display_inner(&self, f: &mut ::core::fmt::Formatter) -> ::core::fmt::Result {
        match self {
            WitnessLayoutUnionReader::SighashAll(item) => write!(f, "{}", item),
            WitnessLayoutUnionReader::SighashAllOnly(item) => write!(f, "{}", item),
            WitnessLayoutUnionReader::Otx(item) => write!(f, "{}", item),
            WitnessLayoutUnionReader::OtxStart(item) => write!(f, "{}", item),
        }
    }
}
