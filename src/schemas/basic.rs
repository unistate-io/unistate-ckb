...
impl From<Vec<Action>> for ActionVec {
...
impl From<Vec<ScriptInfo>> for ScriptInfoVec {
    fn from(v: Vec<ScriptInfo>) -> Self {
        Self::new_builder().set(v).build()
    }
}
#[derive(Clone)]
...
impl BuildingPacketUnion {
    pub(crate) fn display_inner(&self, f: &mut ::core::fmt::Formatter) -> ::core::fmt::Result {
        match self {
            BuildingPacketUnion::BuildingPacketV1(item) => write!(f, "{}", item),
        }
    }
}
impl<'r> BuildingPacketUnionReader<'r> {
    pub(crate) fn display_inner(&self, f: &mut ::core::fmt::Formatter) -> ::core::fmt::Result {
        match self {
            BuildingPacketUnionReader::BuildingPacketV1(item) => write!(f, "{}", item),
        }
    }
}
