...
impl ScriptVecOptBuilder {
    ...
    where
        T: ::core::convert::Into<Option<ScriptVec>>,
    {
        self.0 = v.into();
        self
    }
...
impl From<ScriptVec> for ScriptVecOpt {
    fn from(value: ScriptVec) -> Self {
...
impl XudtWitnessInputBuilder {
    pub const FIELD_COUNT: usize = 4;
    pub fn owner_script<T>(mut self, v: T) -> Self
    where
        T: ::core::convert::Into<ScriptOpt>,
    {
        self.owner_script = v.into();
        self
    }
    pub fn owner_signature<T>(mut self, v: T) -> Self
    where
        T: ::core::convert::Into<BytesOpt>,
    {
        self.owner_signature = v.into();
        self
    }
    pub fn raw_extension_data<T>(mut self, v: T) -> Self
    where
        T: ::core::convert::Into<ScriptVecOpt>,
    {
        self.raw_extension_data = v.into();
        self
    }
    pub fn extension_data<T>(mut self, v: T) -> Self
    where
        T: ::core::convert::Into<BytesVec>,
    {
        self.extension_data = v.into();
        self
    }
}
...
impl RCRuleBuilder {
    ...
    pub const FIELD_SIZES: [usize; 2] = [32, 1];
    pub const FIELD_COUNT: usize = 2;
    pub fn smt_root<T>(mut self, v: T) -> Self
    where
        T: ::core::convert::Into<Byte32>,
    {
        self.smt_root = v.into();
        self
    }
...
impl ::core::iter::FromIterator<Byte32> for RCCellVec {
    fn from_iter<T: IntoIterator<Item = Byte32>>(iter: T) -> Self {
        Self::new_builder().extend(iter).build()
    }
}
impl From<Vec<Byte32>> for RCCellVec {
...
impl RCDataUnion {
    pub(crate) fn display_inner(&self, f: &mut ::core::fmt::Formatter) -> ::core::fmt::Result {
        match self {
            RCDataUnion::RCRule(item) => write!(f, "{}", item),
            RCDataUnion::RCCellVec(item) => write!(f, "{}", item),
        }
    }
}
impl<'r> RCDataUnionReader<'r> {
    pub(crate) fn display_inner(&self, f: &mut ::core::fmt::Formatter) -> ::core::fmt::Result {
        match self {
            RCDataUnionReader::RCRule(item) => write!(f, "{}", item),
            RCDataUnionReader::RCCellVec(item) => write!(f, "{}", item),
        }
    }
}
...
impl From<RCRule> for RCData {
    fn from(value: RCRule) -> Self {
        Self::new_builder().set(value).build()
    }
}
impl From<RCCellVec> for RCData {
    fn from(value: RCCellVec) -> Self {
        Self::new_builder().set(value).build()
    }
}
#[derive(Clone)]
...
impl ::core::iter::FromIterator<Byte> for SmtProof {
    fn from_iter<T: IntoIterator<Item = Byte>>(iter: T) -> Self {
        Self::new_builder().extend(iter).build()
    }
}
impl From<Vec<Byte>> for SmtProof {
    fn from(v: Vec<Byte>) -> Self {
        Self::new_builder().set(v).build()
    }
}
impl ::core::iter::FromIterator<u8> for SmtProof {
...
impl SmtProofEntryBuilder {
    pub const FIELD_COUNT: usize = 2;
    pub fn mask<T>(mut self, v: T) -> Self
    where
        T: ::core::convert::Into<Byte>,
    {
        self.mask = v.into();
...
impl SmtProofEntryVecBuilder {
    ...
    pub fn push<T>(mut self, v: T) -> Self
    where
        T: ::core::convert::Into<SmtProofEntry>,
    {
        self.0.push(v.into());
        self
    }
    ...
    pub fn replace<T>(&mut self, index: usize, v: T) -> Option<SmtProofEntry>
    where
        T: ::core::convert::Into<SmtProofEntry>,
    {
        self.0
...
impl ::core::iter::FromIterator<SmtProofEntry> for SmtProofEntryVec {
    fn from_iter<T: IntoIterator<Item = SmtProofEntry>>(iter: T) -> Self {
        Self::new_builder().extend(iter).build()
    }
}
impl From<Vec<SmtProofEntry>> for SmtProofEntryVec {
    fn from(v: Vec<SmtProofEntry>) -> Self {
        Self::new_builder().set(v).build()
    }
}
#[derive(Clone)]
...
impl SmtUpdateItemBuilder {
    ...
    pub fn packed_values<T>(mut self, v: T) -> Self
    where
        T: ::core::convert::Into<Byte>,
    {
        self.packed_values = v.into();
        self
    }
}
...
impl SmtUpdateItemVecBuilder {
    ...
    pub fn push<T>(mut self, v: T) -> Self
    where
        T: ::core::convert::Into<SmtUpdateItem>,
    {
        self.0.push(v.into());
        self
    }
    ...
    pub fn replace<T>(&mut self, index: usize, v: T) -> Option<SmtUpdateItem>
    where
        T: ::core::convert::Into<SmtUpdateItem>,
    {
        self.0
...
impl ::core::iter::FromIterator<SmtUpdateItem> for SmtUpdateItemVec {
    fn from_iter<T: IntoIterator<Item = SmtUpdateItem>>(iter: T) -> Self {
        Self::new_builder().extend(iter).build()
    }
}
impl From<Vec<SmtUpdateItem>> for SmtUpdateItemVec {
    fn from(v: Vec<SmtUpdateItem>) -> Self {
        Self::new_builder().set(v).build()
    }
}
#[derive(Clone)]
...
impl SmtUpdateActionBuilder {
    pub const FIELD_COUNT: usize = 2;
    pub fn updates<T>(mut self, v: T) -> Self
    where
        T: ::core::convert::Into<SmtUpdateItemVec>,
    {
        self.updates = v.into();
        self
    }
