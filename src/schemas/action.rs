...
impl AddressUnion {
    pub(crate) fn display_inner(&self, f: &mut ::core::fmt::Formatter) -> ::core::fmt::Result {
        match self {
            AddressUnion::Script(item) => write!(f, "{}", item),
        }
    }
}
impl<'r> AddressUnionReader<'r> {
    pub(crate) fn display_inner(&self, f: &mut ::core::fmt::Formatter) -> ::core::fmt::Result {
        match self {
            AddressUnionReader::Script(item) => write!(f, "{}", item),
        }
    }
}
...
impl SporeActionUnion {
    pub(crate) fn display_inner(&self, f: &mut ::core::fmt::Formatter) -> ::core::fmt::Result {
        match self {
            SporeActionUnion::MintSpore(item) => write!(f, "{}", item),
            SporeActionUnion::TransferSpore(item) => write!(f, "{}", item),
            SporeActionUnion::BurnSpore(item) => write!(f, "{}", item),
            SporeActionUnion::MintCluster(item) => write!(f, "{}", item),
            SporeActionUnion::TransferCluster(item) => write!(f, "{}", item),
            SporeActionUnion::MintProxy(item) => write!(f, "{}", item),
            SporeActionUnion::TransferProxy(item) => write!(f, "{}", item),
            SporeActionUnion::BurnProxy(item) => write!(f, "{}", item),
            SporeActionUnion::MintAgent(item) => write!(f, "{}", item),
            SporeActionUnion::TransferAgent(item) => write!(f, "{}", item),
            SporeActionUnion::BurnAgent(item) => write!(f, "{}", item),
        }
    }
}
impl<'r> SporeActionUnionReader<'r> {
    pub(crate) fn display_inner(&self, f: &mut ::core::fmt::Formatter) -> ::core::fmt::Result {
        match self {
            SporeActionUnionReader::MintSpore(item) => write!(f, "{}", item),
            SporeActionUnionReader::TransferSpore(item) => write!(f, "{}", item),
            SporeActionUnionReader::BurnSpore(item) => write!(f, "{}", item),
            SporeActionUnionReader::MintCluster(item) => write!(f, "{}", item),
            SporeActionUnionReader::TransferCluster(item) => write!(f, "{}", item),
            SporeActionUnionReader::MintProxy(item) => write!(f, "{}", item),
            SporeActionUnionReader::TransferProxy(item) => write!(f, "{}", item),
            SporeActionUnionReader::BurnProxy(item) => write!(f, "{}", item),
            SporeActionUnionReader::MintAgent(item) => write!(f, "{}", item),
            SporeActionUnionReader::TransferAgent(item) => write!(f, "{}", item),
            SporeActionUnionReader::BurnAgent(item) => write!(f, "{}", item),
        }
    }
}
