...
impl RGBPPConfigBuilder {
    ...
    pub const FIELD_SIZES: [usize; 2] = [32, 32];
    pub const FIELD_COUNT: usize = 2;
    pub fn btc_lc_type_hash<T>(mut self, v: T) -> Self
    where
        T: ::core::convert::Into<Byte32>,
    {
        self.btc_lc_type_hash = v.into();
        self
    }
    pub fn btc_time_lock_type_hash<T>(mut self, v: T) -> Self
    where
        T: ::core::convert::Into<Byte32>,
    {
        self.btc_time_lock_type_hash = v.into();
        self
    }
}
...
impl RGBPPLockBuilder {
    ...
    pub const FIELD_SIZES: [usize; 2] = [4, 32];
    pub const FIELD_COUNT: usize = 2;
    pub fn out_index<T>(mut self, v: T) -> Self
    where
        T: ::core::convert::Into<Uint32>,
    {
        self.out_index = v.into();
        self
    }
    pub fn btc_txid<T>(mut self, v: T) -> Self
    where
        T: ::core::convert::Into<Byte32>,
    {
        self.btc_txid = v.into();
        self
    }
}
...
impl ExtraCommitmentDataBuilder {
    ...
    pub const FIELD_SIZES: [usize; 2] = [1, 1];
    pub const FIELD_COUNT: usize = 2;
    pub fn input_len<T>(mut self, v: T) -> Self
    where
        T: ::core::convert::Into<Byte>,
    {
        self.input_len = v.into();
        self
    }
    pub fn output_len<T>(mut self, v: T) -> Self
    where
        T: ::core::convert::Into<Byte>,
    {
        self.output_len = v.into();
        self
    }
}
...
impl RGBPPUnlockBuilder {
    ...
    pub fn extra_data<T>(mut self, v: T) -> Self
    where
        T: ::core::convert::Into<ExtraCommitmentData>,
    {
        self.extra_data = v.into();
        self
    }
    pub fn btc_tx<T>(mut self, v: T) -> Self
    where
    ...
    pub fn btc_tx_proof<T>(mut self, v: T) -> Self
    where
        T: ::core::convert::Into<Bytes>,
    {
        self.btc_tx_proof = v.into();
        self
    }
}
...
impl BTCTimeLockBuilder {
    pub const FIELD_COUNT: usize = 3;
    pub fn lock_script<T>(mut self, v: T) -> Self
    where
        T: ::core::convert::Into<Script>,
    {
        self.lock_script = v.into();
        self
    }
